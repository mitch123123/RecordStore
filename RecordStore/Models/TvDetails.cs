...
namespace MovieStore.Models
{
    internal class TvDetails
    {
        ...
        public static Root GetTvDetails(int TvId)
        {
            using (var http = new HttpClient())
            {
                var endpoint = $"https://api.themoviedb.org/3/tv/{TvId}?api_key=73321a7b17e84973837c579c8bb62fe7";
